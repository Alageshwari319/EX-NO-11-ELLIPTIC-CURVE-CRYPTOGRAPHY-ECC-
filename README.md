...
scanf("%lld", &privateA); 
printf("Enter Krithi's private key: "); 
scanf("%lld", &privateB); 
publicA = scalarMultiplication(G, privateA, a, p);
publicB = scalarMultiplication(G, privateB, a, p); 
printf("Alageshwari's public key: (%lld, %lld)\n", publicA.x, publicA.y); 
printf("Krithi's public key: (%lld, %lld)\n", publicB.x, publicB.y); 
...
<img width="1920" height="1200" alt="image" src="https://github.com/user-attachments/assets/ff0e7ff6-1ad2-44cf-a46d-480472c73dd5" />
